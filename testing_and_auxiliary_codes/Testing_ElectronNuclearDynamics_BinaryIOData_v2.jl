...
# run command = julia -O3 -t 4 Testing_ElectronNuclearDynamics_BinaryIOData.jl > Output_Testing_ElectronNuclearDynamics_BinaryIOData.log
...
@time begin
    ...
    println("ΔrH=$(round(ΔrH/Angstrom_to_au,digits=4))[Å]; ΔχH=$(round(ΔχH/(Angstrom_to_au),digits=4))[Å]")
    ...
    write_bin(electronic_ρ_matrix_χ_plus_r, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(nuclear_ρ_matrix_χ_plus_χ, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(total_S_2D_χ_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(electronic_S_χ_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(nuclear_S_χ_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(mutual_info_χ_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(r_ExpValue_χ_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    bin_outfile_name = path_images*"ExpectationValue_χ_vs_time_Rc$(round(Rc/Angstrom_to_au;digits=2))_grid$(n_1D_r)x$(n_1D_R).bin"
    write_bin(χ_ExpValue_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    write_bin(r_variance_χ_plus_t, bin_outfile_name; existing_file=existing_data);
    ...
    bin_outfile_name = path_images*"Variance_χ_vs_time_Rc$(round(Rc/Angstrom_to_au;digits=2))_grid$(n_1D_r)x$(n_1D_R).bin"
    write_bin(χ_variance_plus_t, bin_outfile_name; existing_file=existing_data);
end
